      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3 text-xs lg:text-sm">
          ...
          <button
            ...
            className={`flex min-w-[132px] items-center justify-center gap-1 rounded-md bg-[#1C4336]/[14%] py-1.5 ${
              book.isFavourite ? "text-[#1C4336]" : "text-red-400"
            } transition-all hover:bg-[#1C4336]/[24%] lg:py-1.5`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
